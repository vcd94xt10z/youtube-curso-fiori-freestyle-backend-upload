class ZCL_ZFILE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZFILE_MPC=================CP' ##NO_TEXT.
...
CLASS ZCL_ZFILE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZFILE_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Fileid' iv_abap_fieldname = 'FILEID' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250511072122'.                  "#EC NOTEXT
